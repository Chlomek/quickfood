...
class _RestaurantMenuScreenState extends State<RestaurantMenuScreen> {
		...
		return Padding(
			...
			child: Row(
				children: [
					...
					CircleAvatar(
						radius: 21,
						backgroundColor: const Color(0xFF97A7B8),
						child: Text(
	...
	List<String> _extractCategories(List<QueryDocumentSnapshot<Map<String, dynamic>>> docs) {
					...
					return GestureDetector(
						...
						child: Container(
							...
							decoration: BoxDecoration(
								...
								border: Border.all(
									color: selected ? const Color(0xFFFF8A1E) : const Color(0xFFD8DAE1),
								),
							),
								...
								Row(
									children: [
										...
										GestureDetector(
											...
											child: const Icon(Icons.more_horiz, color: Color(0xFF2E3243)),
										),
									],
								),
		...
		return RestaurantBottomNavBar(
			...
			onHomeTap: () {
				Navigator.pushReplacement(
					context,
					MaterialPageRoute(
						builder: (_) => RestaurantHomeScreen(restaurantId: widget.restaurantId),
					),
				);
			},
			onCenterTap: () async {
